...
![Alt text](https://github.com/Troops3/TinyRAM/blob/main/docs/waveform1.png "gate level test")

_Figure 1: Gate level Test_


![Alt text](https://github.com/Troops3/TinyRAM/blob/main/docs/waveform2.png "ideal test")
